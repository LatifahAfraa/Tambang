...
<div class="card">
    ...
    <div class="card-body">
        <div class="basic-form">
            <form action="{{ route('transaksi.completes.op2',$transaksi->transaksi_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    <select name="kendaraan" class="form-select" id="kendaraan">
                ...
                <div class="form-group">
                    <input type="number" class="form-control input-rounded" value="{{ $transaksi->qty }}" name="qty">
                </div>
